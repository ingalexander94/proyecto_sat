 ...
 export const itemsaEconomicRisks: String[]=[
"Estrato",
"Situación Laboral",
...
export const itemAcademicRisks: String[]=[
...
export const itemsaIndividualRisks: String[]=[
...
export const itemsaInstitucionalRisks: String[]=[
